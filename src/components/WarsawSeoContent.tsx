...
const problems = [
  {
    ...
    answer:
      "When someone in Warsaw searches for what you offer, your competitors are getting the click. SEO fixes that by getting your business to the top of the results, so customers find you first, not the other guy on US-30.",
  },
  {
  ...
  {
    question: "You don't show up when people search 'near me' in Warsaw?",
    answer:
...
const services = [
  {
    ...
    desc: "Find the exact terms Warsaw customers are typing into Google and build a plan to rank for them. Data-driven, not guesswork.",
    accent: "purple",
    icon: (
  ...
  {
    title: "Local SEO",
    desc: "Dominate Warsaw search results. Google Business Profile optimization, local citations, reviews strategy, and map pack visibility.",
    accent: "emerald",
    icon: (
      <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
  ...
  },
  {
    ...
    desc: "Blog posts, service pages, and location pages that answer the questions Warsaw customers are actually searching for.",
    accent: "amber",
    icon: (
      <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
...
export default function WarsawSeoContent() {
  return (
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-12">
          <FadeIn>
            <div className="mb-16">
              ...
              <h2 className="text-3xl sm:text-4xl font-bold text-white tracking-tight mb-4">
                SEO Services for Warsaw Businesses
              </h2>
              <p className="text-neutral-400 text-lg max-w-2xl">
                From local shops near Center Lake to businesses across Kosciusko County, I help
                Warsaw companies get found on Google and get more website traffic month after month.
              </p>
            </div>
          </FadeIn>
            ...
            <div className="relative rounded-2xl bg-white/[0.03] border border-white/[0.06] p-8 sm:p-12 overflow-hidden">
              ...
              <div className="relative">
                ...
                <p className="text-neutral-400 leading-relaxed mb-4">
                  Not every business needs a full SEO expert, and I&apos;m honest about that. Some Warsaw
        ...
        <div className="max-w-4xl mx-auto px-6 lg:px-12">
          <FadeIn>
            <div className="relative rounded-2xl bg-white/[0.03] border border-white/[0.06] p-8 sm:p-12">
              <h2 className="text-2xl sm:text-3xl font-bold text-white tracking-tight mb-4">
                Why Warsaw Businesses Choose a Local SEO Expert
              </h2>
              <p className="text-neutral-400 leading-relaxed mb-6">
                A big SEO agency from out of state doesn&apos;t know Warsaw. They don&apos;t know that
                your customers search differently near Winona Lake versus Downtown, or that local
                citations in Kosciusko County directories matter. I&apos;m based in South Bend, about an hour
              ...
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-5">
                <div className="p-5 rounded-xl bg-white/[0.03] border border-white/[0.04]">
                  ...
                  <p className="text-neutral-500 text-sm">Based in Indiana, I understand Warsaw search patterns and local competition</p>
                </div>
                <div className="p-5 rounded-xl bg-white/[0.03] border border-white/[0.04]">
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-12">
          <FadeIn>
            <div className="text-center mb-12">
              <h2 className="text-2xl sm:text-3xl font-bold text-white tracking-tight mb-3">
                SEO for Warsaw Businesses Like Yours
              </h2>
              <p className="text-neutral-400 max-w-xl mx-auto">
                Whether you&apos;re in construction, healthcare (including the orthopedic industry), retail, or services
                in the Warsaw area, SEO can help customers find you before they find your competitors.
              </p>
            </div>
          </FadeIn>
          ...
          <FadeIn>
            <div className="text-center max-w-2xl mx-auto">
              ...
              <p className="text-neutral-400 text-lg mb-8">
                ...
                I&apos;ll help you figure out the right path. Free SEO audit for Warsaw businesses.
              </p>
