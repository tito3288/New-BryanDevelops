...
const problems = [
  {
    ...
    answer:
      "Niles customers judge your business in seconds. If your site looks outdated, they're clicking away and finding a competitor on Main Street or in the Four Flags Area. A modern, professional website builds instant credibility and keeps visitors engaged.",
  },
  {
    question: "You paid for a website but can't even update your own hours?",
    answer:
      "This is one of the most common frustrations I hear from Niles business owners. The original developer is gone, and now changing a phone number feels impossible. I build sites you can actually manage, and I train you how to do it.",
  },
  {
    question: "Your site doesn't show up when people search Niles?",
    answer:
      "A great-looking website means nothing if Niles customers can't find it on Google. Every site I build comes with SEO foundations baked in: proper structure, fast loading speeds, mobile-friendly design, and local keyword optimization.",
  },
  {
    question: "You need an online store but don't know where to start?",
    answer:
      "Whether you're selling products from a shop in Downtown Niles or shipping nationwide, I'll set up your online store on Shopify, WooCommerce, or Squarespace. Payments, inventory, and shipping all connected and ready to go.",
  },
];
...
const services = [
  {
    ...
    desc: "A site designed around your Niles business, your brand, and your customers. Not a generic template with your logo dropped in.",
    accent: "indigo",
    icon: (
  ...
  },
  {
    ...
    desc: "Already have a site that needs a refresh? I'll modernize the design, improve the speed, and make sure it's actually converting Niles visitors into customers.",
    accent: "purple",
    icon: (
      <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
...
export default function NilesWebDevContent() {
  return (
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-6 lg:px-12 py-32 sm:py-40">
          <FadeIn>
            <p className="text-indigo-600 text-sm font-semibold tracking-widest uppercase mb-4">
              Web Design & Development, Niles, MI
            </p>
            ...
            <p className="text-neutral-500 text-lg sm:text-xl max-w-2xl mb-8 leading-relaxed">
              Affordable, modern websites built for small businesses in Niles, Berrien County, and the Michiana area.
          ...
          <FadeIn delay={200}>
            <p className="mt-12 text-neutral-400 text-sm">
              Based right next door in South Bend, proudly serving Niles, Berrien County, and businesses nationwide.
            </p>
          </FadeIn>
        </div>
      </section>
          ...
          <FadeIn>
            <div className="text-center mb-14">
              <h2 className="text-3xl sm:text-4xl font-bold text-neutral-900 tracking-tight mb-4">
                Niles Business Owners: Sound Familiar?
              </h2>
              <p className="text-neutral-500 text-lg max-w-xl mx-auto">
                Whether you&apos;re running a shop in Downtown Niles or a service business in the Four Flags Area,
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-12">
          <FadeIn>
            <div className="mb-16">
              ...
              <h2 className="text-3xl sm:text-4xl font-bold text-neutral-900 tracking-tight mb-4">
                Web Design Services for Niles Companies
              </h2>
              <p className="text-neutral-500 text-lg max-w-2xl">
                From businesses along the St. Joseph River to established shops in Downtown Niles, I build
          ...
          <FadeIn>
            <div className="text-center mb-12">
              ...
              <p className="text-neutral-500 text-base max-w-xl mx-auto">
                ...
                the best fit for your Niles business based on your budget and goals.
              </p>
            </div>
          </FadeIn>
          ...
          <FadeIn>
            <div className="relative rounded-2xl bg-neutral-50 border border-neutral-200 p-8 sm:p-12">
              <h2 className="text-2xl sm:text-3xl font-bold text-neutral-900 tracking-tight mb-4">
                Why Niles Businesses Choose a Local Web Developer
              </h2>
              <p className="text-neutral-500 leading-relaxed mb-6">
                You could go with a big agency from out of state, or you could work with someone who
                understands Michiana businesses. Based right next door in South Bend, just across the state line,
                I work with Niles companies who want a developer they can actually reach.
              </p>
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-5">
                <div className="p-5 rounded-xl bg-white border border-neutral-200">
                  ...
                  <p className="text-neutral-500 text-sm">Based in South Bend, just minutes away across the Michigan border</p>
                </div>
                <div className="p-5 rounded-xl bg-white border border-neutral-200">
      ...
      <section className="relative py-20 sm:py-24">
        <div className="max-w-7xl mx-auto px-6 lg:px-12">
          <FadeIn>
            <div className="text-center mb-12">
              <h2 className="text-2xl sm:text-3xl font-bold text-neutral-900 tracking-tight mb-3">
                Websites Built for Niles Businesses Like Yours
              </h2>
              <p className="text-neutral-500 max-w-xl mx-auto">
                Whether you&apos;re in manufacturing, healthcare, agriculture, retail, or professional services
                in the Niles area, a professional website can transform how customers find and trust you.
              </p>
            </div>
          </FadeIn>

          <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-6 gap-3">
            {["Manufacturing", "Healthcare", "Retail", "Restaurants", "Agriculture", "Professional Services"].map((industry, i) => (
          ...
          <FadeIn>
            <div className="text-center max-w-2xl mx-auto">
              ...
              <p className="text-neutral-500 text-lg mb-8">
                ...
                loads fast, and actually brings you customers. Free consultation for Niles businesses.
              </p>
