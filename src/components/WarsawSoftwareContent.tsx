...
const problems = [
  {
    ...
    answer:
      "Warsaw is a hub for innovation, and your tools should reflect that. Custom software replaces the manual busywork with automated systems that track leads, manage orders, and handle follow-ups for you.",
  },
  {
    question: "Losing customers because you can't respond fast enough?",
    answer:
      "Whether it's a missed call from a client near Winona Lake or a late reply to an online inquiry, speed wins. I build AI-powered tools that respond instantly: texts, chatbots, and automated follow-ups.",
  },
  {
    question: "Paying for 5 different tools that don't talk to each other?",
    answer:
      "Scheduling app, CRM, invoicing tool, email platform. Sound familiar? I build one custom system that connects everything so your Warsaw team isn't wasting time switching between tabs.",
  },
  {
...
export default function WarsawSoftwareContent() {
  return (
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-6 lg:px-12 py-32 sm:py-40">
          <FadeIn>
            <h1 className="text-emerald-400 text-sm font-semibold tracking-widest uppercase mb-4">
              Software & App Development — Warsaw, IN
            </h1>
            ...
            <p className="text-neutral-400 text-lg sm:text-xl max-w-2xl mb-8 leading-relaxed">
              Warsaw is the orthopedic capital of the world, and its businesses deserve
              better than off-the-shelf software. I build custom tools, automations, and apps
              designed for companies across Warsaw and Kosciusko County, from medical device firms to local services.
            </p>
          ...
          <FadeIn delay={200}>
            <p className="mt-12 text-neutral-600 text-sm">
              Based in South Bend, proudly serving Warsaw, north-central Indiana, and businesses nationwide.
            </p>
          </FadeIn>
        </div>
      </section>

      {/* ========== PAIN POINTS — Warsaw specific ========== */}
          ...
          <FadeIn>
            <div className="text-center mb-14">
              ...
              <p className="text-neutral-400 text-lg max-w-xl mx-auto">
                Whether you&apos;re in Downtown Warsaw or running a business along the US-30 corridor,
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-12">
          <FadeIn>
            <div className="mb-16">
              ...
              <h2 className="text-3xl sm:text-4xl font-bold text-white tracking-tight mb-4">
                Software Solutions for Warsaw Companies
              </h2>
              <p className="text-neutral-400 text-lg max-w-2xl">
                From medical device companies to local businesses along US-30, I build
          ...
          <FadeIn>
            <div className="relative rounded-2xl bg-white/[0.03] border border-white/[0.06] p-8 sm:p-12">
              <h2 className="text-2xl sm:text-3xl font-bold text-white tracking-tight mb-4">
                Why Warsaw Businesses Choose a Local Developer
              </h2>
              <p className="text-neutral-400 leading-relaxed mb-6">
                ...
                and I work with Warsaw companies who want a developer they can actually talk to.
              </p>
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-12">
          <FadeIn>
            <div className="text-center mb-12">
              <h2 className="text-2xl sm:text-3xl font-bold text-white tracking-tight mb-3">
                Built for Warsaw Businesses Like Yours
              </h2>
              <p className="text-neutral-400 max-w-xl mx-auto">
                Whether you&apos;re in manufacturing, healthcare, startups, or professional services in the Warsaw area, custom software can transform how you operate.
              </p>
            </div>
          </FadeIn>
          ...
          <FadeIn>
            <div className="text-center max-w-2xl mx-auto">
              ...
              <p className="text-neutral-400 text-lg mb-8">
                ...
                Free consultation for Warsaw businesses.
              </p>
