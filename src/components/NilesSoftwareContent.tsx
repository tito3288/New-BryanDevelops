...
const problems = [
  {
    ...
    answer:
      "Niles is a growing community in the Four Flags area, and your tools should keep up. Custom software replaces the manual busywork with automated systems that track leads, manage orders, and handle follow-ups for you.",
  },
  {
    question: "Losing customers because you can't respond fast enough?",
    answer:
      "Whether it's a missed call from a client on Main Street or a late reply to an online inquiry, speed wins. I build AI-powered tools that respond instantly: texts, chatbots, and automated follow-ups.",
  },
  {
    question: "Paying for 5 different tools that don't talk to each other?",
    answer:
      "Scheduling app, CRM, invoicing tool, email platform. Sound familiar? I build one custom system that connects everything so your Niles team isn't wasting time switching between tabs.",
  },
  {
...
export default function NilesSoftwareContent() {
  return (
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-6 lg:px-12 py-32 sm:py-40">
          <FadeIn>
            <h1 className="text-emerald-400 text-sm font-semibold tracking-widest uppercase mb-4">
              Software & App Development — Niles, MI
            </h1>
            ...
            <p className="text-neutral-400 text-lg sm:text-xl max-w-2xl mb-8 leading-relaxed">
              Niles sits at the gateway between Indiana and Michigan, and its businesses deserve
              better than off-the-shelf software. I build custom tools, automations, and apps
              designed for companies across the Four Flags area and Berrien County, from manufacturing firms to Michiana service providers.
            </p>
          ...
          <FadeIn delay={200}>
            <p className="mt-12 text-neutral-600 text-sm">
              Based right next door in South Bend, just across the state line. Proudly serving Niles, southwest Michigan, and businesses nationwide.
            </p>
          </FadeIn>
        </div>
      </section>

      {/* ========== PAIN POINTS — Niles specific ========== */}
          ...
          <FadeIn>
            <div className="text-center mb-14">
              ...
              <p className="text-neutral-400 text-lg max-w-xl mx-auto">
                Whether you&apos;re in Downtown Niles or running a business along the St. Joseph River,
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-12">
          <FadeIn>
            <div className="mb-16">
              ...
              <h2 className="text-3xl sm:text-4xl font-bold text-white tracking-tight mb-4">
                Software Solutions for Niles Companies
              </h2>
              <p className="text-neutral-400 text-lg max-w-2xl">
                From manufacturers near Fort St. Joseph to shops along Main Street, I build
          ...
          <FadeIn>
            <div className="relative rounded-2xl bg-white/[0.03] border border-white/[0.06] p-8 sm:p-12">
              <h2 className="text-2xl sm:text-3xl font-bold text-white tracking-tight mb-4">
                Why Niles Businesses Choose a Local Developer
              </h2>
              <p className="text-neutral-400 leading-relaxed mb-6">
                ...
                I work with Niles companies who want a developer they can actually talk to.
              </p>
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-12">
          <FadeIn>
            <div className="text-center mb-12">
              <h2 className="text-2xl sm:text-3xl font-bold text-white tracking-tight mb-3">
                Built for Niles Businesses Like Yours
              </h2>
              <p className="text-neutral-400 max-w-xl mx-auto">
                Whether you&apos;re in manufacturing, healthcare, agriculture, or professional services in the Niles area, custom software can transform how you operate.
              </p>
            </div>
          </FadeIn>

          <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-6 gap-3">
            {["Manufacturing", "Healthcare", "Agriculture", "Restaurants", "Real Estate", "Professional Services"].map((industry, i) => (
          ...
          <FadeIn>
            <div className="text-center max-w-2xl mx-auto">
              ...
              <p className="text-neutral-400 text-lg mb-8">
                ...
                Free consultation for Niles businesses.
              </p>
