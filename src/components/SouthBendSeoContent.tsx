...
const problems = [
  {
    ...
    answer:
      "When someone in South Bend searches for what you offer, your competitors are getting the click. SEO fixes that by getting your business to the top of the results, so customers find you first, not the other business down Michigan Street.",
  },
  {
    question: "You're spending money on ads but not seeing real growth?",
    answer:
      "Ads stop working the second you stop paying. SEO builds long-term traffic that keeps coming even when you're not running campaigns. It's how you get more website traffic without constantly feeding the ad budget.",
  },
  {
    question: "You don't show up when people search 'near me' in South Bend?",
    answer:
      "Local SEO is how businesses show up in Google Maps and 'near me' searches. If your Google Business Profile isn't optimized and your site isn't structured for local search, you're invisible to customers in your own neighborhood.",
  },
  {
...
const services = [
  {
    ...
    desc: "Find the exact terms South Bend customers are typing into Google and build a plan to rank for them. Data-driven, not guesswork.",
    accent: "purple",
    icon: (
  ...
  {
    title: "Local SEO",
    desc: "Dominate South Bend and Michiana search results. Google Business Profile optimization, local citations, reviews strategy, and map pack visibility.",
    accent: "emerald",
    icon: (
      <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
  ...
  },
  {
    ...
    desc: "Blog posts, service pages, and location pages that answer the questions South Bend customers are actually searching for.",
    accent: "amber",
    icon: (
      <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
...
export default function SouthBendSeoContent() {
  return (
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-6 lg:px-12 py-32 sm:py-40">
          <FadeIn>
            ...
            <p className="text-neutral-400 text-lg sm:text-xl max-w-2xl mb-8 leading-relaxed">
              Stop relying on ads to get found online. I help South Bend businesses show up on Google
              organically, so customers find you when they&apos;re searching for exactly what you offer.
              Month-to-month, no long contracts, and I&apos;m based right here in town.
            </p>
          ...
          <FadeIn>
            <div className="text-center mb-14">
              ...
              <p className="text-neutral-400 text-lg max-w-xl mx-auto">
                ...
                where to start. These are the problems I solve every day for local businesses.
              </p>
            </div>
          </FadeIn>
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-12">
          <FadeIn>
            <div className="mb-16">
              ...
              <h2 className="text-3xl sm:text-4xl font-bold text-white tracking-tight mb-4">
                SEO Services for South Bend Businesses
              </h2>
              <p className="text-neutral-400 text-lg max-w-2xl">
                From Downtown shops to businesses along the Grape Road corridor, I help
                South Bend companies get found on Google and get more website traffic month after month.
              </p>
            </div>
          </FadeIn>
            ...
            <div className="relative rounded-2xl bg-white/[0.03] border border-white/[0.06] p-8 sm:p-12 overflow-hidden">
              ...
              <div className="relative">
                ...
                <p className="text-neutral-400 leading-relaxed mb-4">
                  Not every South Bend business needs a full SEO expert, and I&apos;m honest about that. Some
                ...
                <p className="text-neutral-500 text-sm italic mb-8">
                  I believe in giving businesses options. I&apos;d rather help you succeed with the right fit
        ...
        <div className="max-w-4xl mx-auto px-6 lg:px-12">
          <FadeIn>
            <div className="relative rounded-2xl bg-white/[0.03] border border-white/[0.06] p-8 sm:p-12">
              <h2 className="text-2xl sm:text-3xl font-bold text-white tracking-tight mb-4">
                Your SEO Expert Lives in South Bend
              </h2>
              <p className="text-neutral-400 leading-relaxed mb-6">
                I live and work in South Bend. I know how people search here, which local directories
                matter, and what your competition looks like on Google. That local knowledge makes a real
                difference in SEO strategy compared to a generic agency from out of state.
              </p>
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-5">
                <div className="p-5 rounded-xl bg-white/[0.03] border border-white/[0.04]">
                  ...
                  <p className="text-neutral-500 text-sm">I know South Bend search patterns, local directories, and neighborhood competition</p>
                </div>
                <div className="p-5 rounded-xl bg-white/[0.03] border border-white/[0.04]">
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-12">
          <FadeIn>
            <div className="text-center mb-12">
              <h2 className="text-2xl sm:text-3xl font-bold text-white tracking-tight mb-3">
                SEO for South Bend Businesses Like Yours
              </h2>
              <p className="text-neutral-400 max-w-xl mx-auto">
                Whether you&apos;re in healthcare near Beacon, a restaurant on Eddy Street, a contractor
                serving the west side, or a professional services firm Downtown, SEO helps customers find you first.
              </p>
            </div>
          </FadeIn>
          ...
          <FadeIn>
            <div className="text-center max-w-2xl mx-auto">
              ...
              <p className="text-neutral-400 text-lg mb-8">
                ...
                I&apos;ll help you figure out the right path. Free SEO audit for South Bend businesses.
              </p>
