...
const problems = [
  {
    question: "Are you still running your business on spreadsheets and manual processes?",
    answer:
      "South Bend businesses are growing fast, especially around the Notre Dame corridor and Downtown. If your team is still tracking leads in spreadsheets or managing orders by hand, custom software can automate all of that and give you hours back every week.",
  },
  {
    question: "Losing customers because you can't respond fast enough?",
    answer:
      "A missed call from a homeowner near Granger or a late reply to an online inquiry means lost revenue. I build AI-powered tools that respond instantly: texts, chatbots, and automated follow-ups that keep leads warm while you focus on your work.",
  },
  {
    question: "Paying for too many tools that don't talk to each other?",
    answer:
      "Scheduling app, CRM, invoicing tool, email platform. Sound familiar? I build one custom system that connects everything so your South Bend team isn't wasting time switching between tabs and copying data by hand.",
  },
  {
    question: "Can't see how your business is actually performing?",
    answer:
      "Custom dashboards give you real-time numbers: revenue, leads, customer activity, all in one clean view. No more guessing, no more end-of-month surprises. See exactly how your South Bend operation is doing at any moment.",
  },
];
...
export default function SouthBendSoftwareContent() {
  return (
          ...
          <FadeIn>
            <div className="text-center mb-14">
              ...
              <p className="text-neutral-400 text-lg max-w-xl mx-auto">
                Whether you&apos;re running a business Downtown, near the university, or along the
                Grape Road corridor in Mishawaka, these problems cost you time and money every day.
              </p>
            </div>
          </FadeIn>
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-12">
          <FadeIn>
            <div className="mb-16">
              ...
              <h2 className="text-3xl sm:text-4xl font-bold text-white tracking-tight mb-4">
                Software Solutions for South Bend Companies
              </h2>
              <p className="text-neutral-400 text-lg max-w-2xl">
                From tech startups near Notre Dame to manufacturers along the St. Joseph River, I build
        ...
        <div className="max-w-4xl mx-auto px-6 lg:px-12 text-center">
          <FadeIn>
            ...
            <p className="text-neutral-400 text-lg mb-6 max-w-xl mx-auto">
              Let&apos;s talk about what custom software can do for your business. Free consultation, no pressure.
            </p>
            <Link
              href="/contact"
              className="inline-flex px-7 py-3.5 rounded-full bg-gradient-to-r from-indigo-500 to-purple-500 text-white font-semibold text-sm tracking-wide hover:from-indigo-600 hover:to-purple-600 transition-all active:scale-[0.98] shadow-[0_4px_20px_rgba(99,102,241,0.3)]"
            >
              Get a Free Consultation
            </Link>
          </FadeIn>
          ...
          <FadeIn>
            <div className="relative rounded-2xl bg-white/[0.03] border border-white/[0.06] p-8 sm:p-12">
              <h2 className="text-2xl sm:text-3xl font-bold text-white tracking-tight mb-4">
                Your Developer Lives in South Bend
              </h2>
              <p className="text-neutral-400 leading-relaxed mb-6">
                I&apos;m not a faceless agency from another state. I live right here in South Bend,
                and I understand the local business landscape. Need to meet in person? Let&apos;s grab
                coffee. Want to walk through your workflow together? I&apos;m down the road.
              </p>
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-5">
                <div className="p-5 rounded-xl bg-white/[0.03] border border-white/[0.04]">
                  ...
                  <p className="text-neutral-500 text-sm">Headquartered in South Bend, available for in-person meetings anytime</p>
                </div>
                <div className="p-5 rounded-xl bg-white/[0.03] border border-white/[0.04]">
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-12">
          <FadeIn>
            <div className="text-center mb-12">
              <h2 className="text-2xl sm:text-3xl font-bold text-white tracking-tight mb-3">
                Built for South Bend Businesses Like Yours
              </h2>
              <p className="text-neutral-400 max-w-xl mx-auto">
                Whether you&apos;re in manufacturing, healthcare, the Notre Dame startup ecosystem,
                home services, or professional services, custom software can transform how you operate.
              </p>
            </div>
          </FadeIn>

          <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-6 gap-3">
            {["Manufacturing", "Healthcare", "Startups", "Restaurants", "Real Estate", "Professional Services"].map((industry, i) => (
          ...
          <FadeIn>
            <div className="text-center max-w-2xl mx-auto">
              ...
              <p className="text-neutral-400 text-lg mb-8">
                Whether you need a simple automation or a full custom platform, I&apos;ll help you figure out
                the smartest solution. No pressure, no jargon. Free consultation for South Bend businesses.
              </p>
