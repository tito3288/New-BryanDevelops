...
const problems = [
  {
    ...
    answer:
      "LaPorte businesses are growing fast, and your tools should keep up. Custom software replaces the manual busywork with automated systems that track leads, manage orders, and handle follow-ups for you.",
  },
  {
    question: "Losing customers because you can't respond fast enough?",
    answer:
      "Whether it's a missed call from a customer near Pine Lake or a late reply to an online inquiry, speed wins. I build AI-powered tools that respond instantly: texts, chatbots, and automated follow-ups.",
  },
  {
    question: "Paying for 5 different tools that don't talk to each other?",
    answer:
      "Scheduling app, CRM, invoicing tool, email platform. Sound familiar? I build one custom system that connects everything so your LaPorte team isn't wasting time switching between tabs.",
  },
  {
...
export default function LaPorteSoftwareContent() {
  return (
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-6 lg:px-12 py-32 sm:py-40">
          <FadeIn>
            <p className="text-emerald-400 text-sm font-semibold tracking-widest uppercase mb-4">
              Software & App Development, LaPorte, IN
            </p>
            ...
            <p className="text-neutral-400 text-lg sm:text-xl max-w-2xl mb-8 leading-relaxed">
              LaPorte&apos;s diverse economy spans manufacturing, healthcare, agriculture, and
              tourism, and your business deserves better than off-the-shelf software. I build custom tools, automations, and apps
              designed for companies across LaPorte and LaPorte County, from local manufacturers to lakeside tourism businesses.
            </p>
          ...
          <FadeIn delay={200}>
            <p className="mt-12 text-neutral-600 text-sm">
              Based in South Bend, just 30 minutes away. Proudly serving LaPorte, northwest Indiana, and businesses nationwide.
            </p>
          </FadeIn>
        </div>
      </section>

      {/* ========== PAIN POINTS — LaPorte specific ========== */}
          ...
          <FadeIn>
            <div className="text-center mb-14">
              ...
              <p className="text-neutral-400 text-lg max-w-xl mx-auto">
                Whether you&apos;re in Downtown LaPorte or running a business along Lincolnway,
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-12">
          <FadeIn>
            <div className="mb-16">
              ...
              <h2 className="text-3xl sm:text-4xl font-bold text-white tracking-tight mb-4">
                Software Solutions for LaPorte Companies
              </h2>
              <p className="text-neutral-400 text-lg max-w-2xl">
                From manufacturers near the LaPorte County Fairgrounds to tourism businesses by the lakes and dunes, I build
          ...
          <FadeIn>
            <div className="relative rounded-2xl bg-white/[0.03] border border-white/[0.06] p-8 sm:p-12">
              <h2 className="text-2xl sm:text-3xl font-bold text-white tracking-tight mb-4">
                Why LaPorte Businesses Choose a Local Developer
              </h2>
              <p className="text-neutral-400 leading-relaxed mb-6">
                ...
                and I work with LaPorte companies who want a developer they can actually talk to.
              </p>
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-5">
                <div className="p-5 rounded-xl bg-white/[0.03] border border-white/[0.04]">
                  ...
                  <p className="text-neutral-500 text-sm">Based in South Bend, available for in-person meetings in LaPorte</p>
                </div>
                <div className="p-5 rounded-xl bg-white/[0.03] border border-white/[0.04]">
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-12">
          <FadeIn>
            <div className="text-center mb-12">
              <h2 className="text-2xl sm:text-3xl font-bold text-white tracking-tight mb-3">
                Built for LaPorte Businesses Like Yours
              </h2>
              <p className="text-neutral-400 max-w-xl mx-auto">
                Whether you&apos;re in manufacturing, healthcare, agriculture, tourism, or retail in the LaPorte area, custom software can transform how you operate.
              </p>
            </div>
          </FadeIn>
          ...
          <FadeIn>
            <div className="text-center max-w-2xl mx-auto">
              ...
              <p className="text-neutral-400 text-lg mb-8">
                ...
                Free consultation for LaPorte businesses.
              </p>
