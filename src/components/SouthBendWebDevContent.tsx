...
const problems = [
  {
    question: "Your website looks outdated and you're losing customers to competitors?",
    answer:
      "South Bend is growing, and customers expect modern, professional websites. If your site looks like it hasn't been updated since 2015, visitors are bouncing to the competitor down Michigan Street. A clean, modern website changes that instantly.",
  },
  {
    question: "You paid for a website but can't even change your own hours?",
    answer:
      "This is one of the most common complaints I hear from South Bend business owners. The original developer disappeared, and now updating a phone number feels impossible. I build sites you can actually manage, and I'll sit down with you and walk through everything.",
  },
  {
    question: "Your business doesn't show up when people search in South Bend?",
    answer:
      "A beautiful website means nothing if nobody finds it. Every site I build comes with SEO foundations baked in: proper structure, fast loading, mobile-friendly design, and local keyword optimization so South Bend customers can find you on Google.",
  },
  {
    question: "You need an online store for your South Bend shop?",
    answer:
      "Whether you're selling from a storefront Downtown, near Eddy Street Commons, or shipping nationwide, I'll get your online store running on Shopify, WooCommerce, or Squarespace with payments, inventory, and shipping all connected.",
  },
];
...
const services = [
  {
    ...
    desc: "A site designed around your South Bend business, your brand, and your customers. Not a cookie-cutter template with your logo swapped in.",
    accent: "indigo",
    icon: (
  ...
  },
  {
    ...
    desc: "Already have a site that needs a refresh? I'll modernize the design, improve performance, and make sure it's actually converting South Bend visitors into customers.",
    accent: "purple",
    icon: (
      <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
  ...
  },
  {
    ...
    desc: "Every website I build is structured for Google from the start: clean code, fast load times, proper headings, meta tags, and mobile optimization all included.",
    accent: "pink",
    icon: (
      <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
...
export default function SouthBendWebDevContent() {
  return (
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-6 lg:px-12 py-32 sm:py-40">
          <FadeIn>
            ...
            <div className="flex flex-wrap items-center gap-3">
              ...
              <div className="hidden sm:flex items-center gap-2 ml-2 px-4 py-2 rounded-full bg-emerald-50 border border-emerald-200">
                ...
                <span className="text-emerald-700 text-xs font-semibold">Based in South Bend</span>
              </div>
            </div>
          </FadeIn>
          ...
          <FadeIn delay={200}>
            <p className="mt-12 text-neutral-400 text-sm">
              Headquartered in South Bend. Serving Mishawaka, Granger, Elkhart, and businesses nationwide.
            </p>
          </FadeIn>
        </div>
      </section>
          ...
          <FadeIn>
            <div className="text-center mb-14">
              <h2 className="text-3xl sm:text-4xl font-bold text-neutral-900 tracking-tight mb-4">
                South Bend Business Owners: Sound Familiar?
              </h2>
              <p className="text-neutral-500 text-lg max-w-xl mx-auto">
                Whether you&apos;re running a shop Downtown, a restaurant near Eddy Street, or a service
                business off Edison Road, these website problems are costing you customers.
              </p>
            </div>
          </FadeIn>
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-12">
          <FadeIn>
            <div className="mb-16">
              ...
              <h2 className="text-3xl sm:text-4xl font-bold text-neutral-900 tracking-tight mb-4">
                Web Design Services for South Bend Companies
              </h2>
              <p className="text-neutral-500 text-lg max-w-2xl">
                From Notre Dame-area startups to established businesses along the Mishawaka corridor, I build
          ...
          <FadeIn>
            <div className="text-center mb-12">
              ...
              <p className="text-neutral-500 text-base max-w-xl mx-auto">
                ...
                the best fit for your South Bend business based on your budget and goals.
              </p>
            </div>
          </FadeIn>
          ...
          <FadeIn>
            <div className="relative rounded-2xl bg-neutral-50 border border-neutral-200 p-8 sm:p-12">
              <h2 className="text-2xl sm:text-3xl font-bold text-neutral-900 tracking-tight mb-4">
                Your Web Developer Lives in South Bend
              </h2>
              <p className="text-neutral-500 leading-relaxed mb-6">
                I&apos;m not a remote agency in another state. I live and work right here in South Bend.
                That means in-person meetings when you want them, a real understanding of the local market,
                and a developer who actually knows the community your business serves.
              </p>
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-5">
                <div className="p-5 rounded-xl bg-white border border-neutral-200">
                  ...
                  <p className="text-neutral-500 text-sm">Based in South Bend, available for coffee shop meetings and in-person walkthroughs</p>
                </div>
                <div className="p-5 rounded-xl bg-white border border-neutral-200">
      ...
      <section className="relative py-20 sm:py-24">
        <div className="max-w-7xl mx-auto px-6 lg:px-12">
          <FadeIn>
            <div className="text-center mb-12">
              <h2 className="text-2xl sm:text-3xl font-bold text-neutral-900 tracking-tight mb-3">
                Websites Built for South Bend Businesses Like Yours
              </h2>
              <p className="text-neutral-500 max-w-xl mx-auto">
                From Notre Dame-area startups to healthcare practices near Beacon, restaurants on Eddy Street,
                and service businesses across the city, a professional website helps customers find and trust you.
              </p>
            </div>
          </FadeIn>
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-12">
          <FadeIn>
            <div className="text-center max-w-2xl mx-auto">
              <p className="text-indigo-600 text-sm font-semibold tracking-widest uppercase mb-4">
                Based in South Bend, Serving Michiana
              </p>
              ...
              <p className="text-neutral-500 text-lg mb-8">
                ...
                loads fast, and actually brings you customers. Free consultation for South Bend businesses.
              </p>
