...
const problems = [
  {
    ...
    answer:
      "When someone in Niles searches for what you offer, your competitors are getting the click. SEO fixes that by getting your business to the top of the results, so customers find you first, not the other guy on Main Street.",
  },
  {
  ...
  {
    question: "You don't show up when people search 'near me' in Niles?",
    answer:
...
const services = [
  {
    ...
    desc: "Find the exact terms Niles customers are typing into Google and build a plan to rank for them. Data-driven, not guesswork.",
    accent: "purple",
    icon: (
  ...
  {
    title: "Local SEO",
    desc: "Dominate Niles search results. Google Business Profile optimization, local citations, reviews strategy, and map pack visibility.",
    accent: "emerald",
    icon: (
      <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
  ...
  },
  {
    ...
    desc: "Blog posts, service pages, and location pages that answer the questions Niles customers are actually searching for.",
    accent: "amber",
    icon: (
      <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
...
export default function NilesSeoContent() {
  return (
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-6 lg:px-12 py-32 sm:py-40">
          <FadeIn>
            ...
            <p className="text-neutral-400 text-lg sm:text-xl max-w-2xl mb-8 leading-relaxed">
              Stop relying on ads to get found online. SEO helps Niles businesses in Berrien County
              and across southwest Michigan show up on Google organically, so customers find you when
              they&apos;re searching for exactly what you offer. Month-to-month, no long contracts.
            </p>
          ...
          <FadeIn delay={200}>
            <p className="mt-12 text-neutral-600 text-sm">
              Based right next door in South Bend, just across the state line. Proudly serving Niles, the Michiana area, and businesses nationwide.
            </p>
          </FadeIn>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-12">
          <FadeIn>
            <div className="mb-16">
              ...
              <h2 className="text-3xl sm:text-4xl font-bold text-white tracking-tight mb-4">
                SEO Services for Niles Businesses
              </h2>
              <p className="text-neutral-400 text-lg max-w-2xl">
                From shops along Downtown Niles to businesses across Berrien County, I help
                Niles companies get found on Google and get more website traffic month after month.
              </p>
            </div>
          </FadeIn>
            ...
            <div className="relative rounded-2xl bg-white/[0.03] border border-white/[0.06] p-8 sm:p-12 overflow-hidden">
              ...
              <div className="relative">
                ...
                <p className="text-neutral-400 leading-relaxed mb-4">
                  Not every business needs a full SEO expert, and I&apos;m honest about that. Some Niles
        ...
        <div className="max-w-4xl mx-auto px-6 lg:px-12">
          <FadeIn>
            <div className="relative rounded-2xl bg-white/[0.03] border border-white/[0.06] p-8 sm:p-12">
              <h2 className="text-2xl sm:text-3xl font-bold text-white tracking-tight mb-4">
                Why Niles Businesses Choose a Local SEO Expert
              </h2>
              <p className="text-neutral-400 leading-relaxed mb-6">
                A big SEO agency from out of state doesn&apos;t know Niles. They don&apos;t know that
                your customers search differently near Downtown Niles versus the Four Flags area, or that local
                citations in Berrien County directories matter for southwest Michigan search patterns. I&apos;m
                based right next door in South Bend, just across the state line, and I understand how businesses
                in the Michiana area operate.
              </p>
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-12">
          <FadeIn>
            <div className="text-center mb-12">
              <h2 className="text-2xl sm:text-3xl font-bold text-white tracking-tight mb-3">
                SEO for Niles Businesses Like Yours
              </h2>
              <p className="text-neutral-400 max-w-xl mx-auto">
                Whether you&apos;re in manufacturing, healthcare, retail, or services
                in the Niles and Berrien County area, SEO can help customers find you before they find your competitors.
              </p>
            </div>
          </FadeIn>
          ...
          <FadeIn>
            <div className="text-center max-w-2xl mx-auto">
              ...
              <p className="text-neutral-400 text-lg mb-8">
                ...
                I&apos;ll help you figure out the right path. Free SEO audit for Niles businesses.
              </p>
